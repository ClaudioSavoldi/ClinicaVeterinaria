    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NomeArmadietto = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Armadietti", x => x.NomeArmadietto);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NomeCassetto = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NomeArmadiettoId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ArmadiettoNomeArmadietto = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cassetti", x => x.NomeCassetto);
                    table.ForeignKey(
                        name: "FK_Cassetti_Armadietti_ArmadiettoNomeArmadietto",
                        column: x => x.ArmadiettoNomeArmadietto,
                        principalTable: "Armadietti",
                        principalColumn: "NomeArmadietto");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroMicrochip = table.Column<int>(type: "int", maxLength: 15, nullable: true),
                    CodiceFiscale = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnagraficheAnimali", x => x.AnimaleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NomeProdotto = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prodotti", x => x.NomeProdotto);
                    table.ForeignKey(
                        name: "FK_Prodotti_Cassetti_NomeCassetto",
                        column: x => x.NomeCassetto,
                        principalTable: "Cassetti",
                        principalColumn: "NomeCassetto",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnagraficaAnimaleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ricoveri_AnagraficheAnimali_AnagraficaAnimaleId",
                        column: x => x.AnagraficaAnimaleId,
                        principalTable: "AnagraficheAnimali",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Visite_AnagraficheAnimali_AnimaleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodiceFiscale = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    NomeProdotto = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NumeroRicetta = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendite_Prodotti_NomeProdotto",
                        column: x => x.NomeProdotto,
                        principalTable: "Prodotti",
                        principalColumn: "NomeProdotto",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendite_Proprietari_CodiceFiscale",
                        column: x => x.CodiceFiscale,
                        principalTable: "Proprietari",
                        principalColumn: "CodiceFiscale",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnagraficheAnimali_CodiceFiscale",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cassetti_ArmadiettoNomeArmadietto",
                table: "Cassetti",
                column: "ArmadiettoNomeArmadietto");

            migrationBuilder.CreateIndex(
                name: "IX_Prodotti_NomeCassetto",
                table: "Prodotti",
                column: "NomeCassetto");

            migrationBuilder.CreateIndex(
                name: "IX_Ricoveri_AnagraficaAnimaleId",
                table: "Ricoveri",
                column: "AnagraficaAnimaleId");

            migrationBuilder.CreateIndex(
                name: "IX_Vendite_CodiceFiscale",
                table: "Vendite",
                column: "CodiceFiscale");

            migrationBuilder.CreateIndex(
                name: "IX_Vendite_NomeProdotto",
                table: "Vendite",
                column: "NomeProdotto");
